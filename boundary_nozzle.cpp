...
Nozzle3DSolidRightBoundary::Nozzle3DSolidRightBoundary():x0(20e-3),r0(0.501e-3),thickness(0.3e-3){}
...
Nozzle3DSolidBoundary::Nozzle3DSolidBoundary():x0(-2e-3), r0(0.751e-3), x1(0+0e-3),r1(0.75e-3),x2(4e-3+0e-3),r2(0.25e-3),x3(7e-3+0e-3),r3(0.5e-3),x4(8e-3+0e-3),r4(1.65e-3), thickness(2*0.3e-3){}
...
Nozzle3DBNLSolidBoundary::Nozzle3DBNLSolidBoundary():x1(0e-3),r1(0.75e-3),x2(4e-3),r2(0.25e-3),x3(7e-3),r3(0.5e-3),x4(8e-3),r4(1.65e-3), thickness(0.3e-3){}
...
int Nozzle3DOutflowBoundary::UpdateInflowBoundary(ParticleData *m_pParticleData, EOS* m_pEOS, double dt, double dx) {
        ...
        for(size_t index=fluidStartIndex;index<fluidEndIndex;index++)
	{
		...
		if(x[index]<xmin || x[index]>xmax || r2>rmax*rmax || volume[index]>volumeforvacuum)
		{
