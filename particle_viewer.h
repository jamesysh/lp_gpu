...
public:
	...
	void setOutputError(bool f){outputerror=f;}
	void setExactSolutionName(std::string s){exactsolution=s;}
	void setAuxiliaryOutput(std::string s){auxiliaryoutput=s;}
