...
Shocktube3D0025SolidBoundary::Shocktube3D0025SolidBoundary():lengthX(5), lengthY(0.49796), lengthZ(0.50157), thickness(0.1) {
        rb = lengthX/2.-thickness;
        lb = -lengthX/2.+thickness;
        nb = lengthY/2.-thickness;
        sb = -lengthY/2.+thickness;
...
int Shocktube3D0025SolidBoundary::operator()(double x, double y, double z, double pressure, double vx, double vy, double vz,
        vector<double>& xb, vector<double>& yb, vector<double>& zb,
        vector<double>& pressureb, vector<double>& vxb, vector<double>& vyb, vector<double>& vzb) {
...
void Shocktube3D0025SolidBoundary::reflect(double x, double y, double z, double pressure, double vx, double vy, double vz, int bx, int by, int bz,
        vector<double>& xb, vector<double>& yb, vector<double>& zb, vector<double>& pressureb, vector<double>& vxb, vector<double>& vyb, vector<double>& vzb) {
...
Shocktube3D0005SolidBoundary::Shocktube3D0005SolidBoundary():lengthX(5), lengthY(0.099593), lengthZ(0.100315), thickness(0.02) {
        rb = lengthX/2.-thickness;
        lb = -lengthX/2.+thickness;
        nb = lengthY/2.-thickness;
        sb = -lengthY/2.+thickness;
...
int Shocktube3D0005SolidBoundary::operator()(double x, double y, double z, double pressure, double vx, double vy, double vz,
        vector<double>& xb, vector<double>& yb, vector<double>& zb,
        vector<double>& pressureb, vector<double>& vxb, vector<double>& vyb, vector<double>& vzb) {
...
void Shocktube3D0005SolidBoundary::reflect(double x, double y, double z, double pressure, double vx, double vy, double vz, int bx, int by, int bz,
        vector<double>& xb, vector<double>& yb, vector<double>& zb, vector<double>& pressureb, vector<double>& vxb, vector<double>& vyb, vector<double>& vzb) {
