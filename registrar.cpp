...
namespace 
{
	...
	// 3d Shocktube
        ...
        BoundaryRegistrar<Shocktube3D0005SolidBoundary> b24_2("shocktube3d0005solidboundary");
	...
	//3d yee vortex
	GeometryRegistrar<Yee3D> r56("yee3d");
        BoundaryRegistrar<Yee3DSolidBoundary> b56("yee3dsolidboundary");
	
	//random distribution
	GeometryRegistrar<Uniform3D> r57("uniform3d");
        GeometryRegistrar<Gaussian3D> r58("gaussian3d");
        GeometryRegistrar<MultiGaussian3D> r59("multigaussian3d");
	
	//pellet ablation
	GeometryRegistrar<PelletLayer> r60("pelletlayer");
        GeometryRegistrar<MultiPelletLayer> r61("multipelletlayer");
