...
public:	
	...
	const bool* const getLeftInflow() const {return m_bLeftInflow;}
        const double* const getLeftIntegral() const {return m_vLeftIntegral;}
        const double* const getRightIntegral() const {return m_vRightIntegral;}

        const double* const getPelletPositionX() const {return m_vPelletPositionX;}
        const double* const getPelletPositionY() const {return m_vPelletPositionY;}
        const double* const getPelletPositionZ() const {return m_vPelletPositionZ;}
        const double* const getPelletRadius() const {return m_vPelletRadius;}
	const double* const getPelletInnerRadius() const {return m_vPelletInnerRadius;}
...
//------------------------Arrays needed in GPU computation----------------------------------------
    int* d_m_vNeighbourListRight;
    int* d_m_vNeighbourListLeft;
    int* d_m_vNeighbourListNorth;
    int* d_m_vNeighbourListSouth;
    int* d_m_vNeighbourListUp;
    int* d_m_vNeighbourListDown;
    
    int* d_m_vNeighbourListRightSize;
    int* d_m_vNeighbourListLeftSize;
    int* d_m_vNeighbourListNorthSize;
    int* d_m_vNeighbourListSouthSize;
    int* d_m_vNeighbourListUpSize;
    int* d_m_vNeighbourListDownSize;
   
    double* d_m_vPressure;
    double* d_m_vVolume;
    double* d_m_vSoundSpeed;
    double* d_m_vTemp1Pressure;
    double* d_m_vTemp1Volume;
    double* d_m_vTemp1SoundSpeed;
    double* d_m_vTemp2Pressure;
    double* d_m_vTemp2Volume;
    double* d_m_vTemp2SoundSpeed;
    
    double* d_m_vVelocityU;
    double* d_m_vVelocityV;
    double* d_m_vVelocityW;
    double* d_m_vTemp1VelocityU;
    double* d_m_vTemp1VelocityV;
    double* d_m_vTemp1VelocityW;
    double* d_m_vTemp2VelocityU;
    double* d_m_vTemp2VelocityV;
    double* d_m_vTemp2VelocityW;

    int* d_m_vLPFOrderRight;
    int* d_m_vLPFOrderLeft;
    int* d_m_vLPFOrderNorth;
    int* d_m_vLPFOrderSouth;
    int* d_m_vLPFOrderUp;
    int* d_m_vLPFOrderDown;
