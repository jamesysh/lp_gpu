...
OBJS   = boundary.o boundary_solid_shocktube.o boundary_solid_shocktube3d.o boundary_solid_tpshocktube.o boundary_solid_gresho.o \
	...
	boundary_nozzle.o boundary_pellet.o geometry_nozzle.o geometry_random.o\
		 geometry_ballexp.o geometry_collision.o geometry_gresho.o geometry_powder_target.o geometry_powder_target_3d.o\
		 geometry_jet.o geometry_shocktube.o geometry_shocktube3d.o geometry_pellet.o hexagonal_packing.o\
...
particle_data.o: particle_data.h particle_data.cu initializer.h
	$(NVCC) $(CUFLAGS) particle_data.cu
